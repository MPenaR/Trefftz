...
def CleanWaveguide(H: float = 1., R: float = 5., lc: float = 0.3, verbosity: int = 0) -> TrefftzMesh[WaveguideRegions]:
    ...
    bottom = geo.Append(["line", p0, p1], bc=WaveguideRegions.GAMMA)
    right  = geo.Append(["line", p1, p2], bc=WaveguideRegions.SIGMA_R)
    top    = geo.Append(["line", p2, p3], bc=WaveguideRegions.GAMMA)
    left   = geo.Append(["line", p3, p0], bc=WaveguideRegions.SIGMA_L)
