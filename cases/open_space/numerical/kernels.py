...
def I_NuNv(arc_u, arc_v, d_u: float_array, d_v: float_array, k: float, NtD_modes: int) -> complex:
...
def I_Nudv(arc_u, arc_v, d_u: float_array, d_v: float_array, k: float, NtD_modes: int) -> complex:
    ...
    I = trapezoid(Nu*conj(dv_dn), theta)*R
