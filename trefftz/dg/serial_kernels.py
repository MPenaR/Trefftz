...
EDGE_TYPE = {edge_dtype: EdgeType.SEGMENT,
...
def I_duv(edge, d_u: float_array, d_v: float_array, k: float) -> complex:
    ...
    match EDGE_TYPE[edge.dtype]:
        case EdgeType.SEGMENT:
            I = I_duv_segment(edge, d_u, d_v, k)
        case EdgeType.ARC:
            I = I_duv_arc(edge, d_u, d_v, k)
...
def I_udv(edge, d_u: float_array, d_v: float_array, k: float) -> complex:
    ...
    match EDGE_TYPE[edge.dtype]:
        case EdgeType.SEGMENT:
            I = I_udv_segment(edge, d_u, d_v, k)
        case EdgeType.ARC:
            I = I_udv_arc(edge, d_u, d_v, k)
...
def I_dudv(edge, d_u: float_array, d_v: float_array, k: float) -> complex:
    ...
    match EDGE_TYPE[edge.dtype]:
        case EdgeType.SEGMENT:
            I = I_dudv_segment(edge, d_u, d_v, k)
        case EdgeType.ARC:
            I = I_dudv_arc(edge, d_u, d_v, k)
...
.. math ::
    ...
    match EDGE_TYPE[edge.dtype]:
        case EdgeType.SEGMENT:
            I = I_uincv_segment(edge, d_inc, d_v, k)
        case EdgeType.ARC:
            I = I_uincv_arc(edge, d_inc, d_v, k)
...
def I_uincdv(edge, d_inc: float_array, d_v: float_array, k: float) -> complex:
    ...
    match EDGE_TYPE[edge.dtype]:
        case EdgeType.SEGMENT:
            I = I_uincdv_segment(edge, d_inc, d_v, k)
        case EdgeType.ARC:
            I = I_uincdv_arc(edge, d_inc, d_v, k)
