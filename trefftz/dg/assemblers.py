...
@dataclass
class Numerics:
    interior_kernel: SerialTransmissionKernel | BlockTransmissionKernel
    local_boundary_kernels: Mapping[type[BoundaryCondition], SerialLocalKernel] | Mapping[type[BoundaryCondition], BlockLocalKernel]
    nonlocal_boundary_kernels: Mapping[type[BoundaryCondition], SerialNonLocalKernel] | Mapping[type[BoundaryCondition], BlockNonLocalKernel]
...
class VectoricedAssembler[B](Assembler[B]):
...
class ParallelAssembler[B](Assembler[B]):
